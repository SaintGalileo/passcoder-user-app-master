import { ActivityIndicator, Dimensions, ScrollView, StyleSheet, Text, TextInput, TouchableOpacity, View, Image, Platform, Keyboard, KeyboardAvoidingView, TouchableWithoutFeedback } from 'react-native'
...
export default function AddNin() {
    ...
    //                     const nin_verified_status = res.status === 201 ? false : true;
    ...
    //                                         type: "success",
    //                                         text1: "Success",
    //                                         text2: `Details uploaded ${nin_verified_status ? "& verified " : ""}successfully!`
    //                                     })
    //                                     nav.goBack();
    //                                 } else {
                            ...
                            <View style={styles.wrapper}>
                                ...
                                <View style={{ marginTop: 50, margin: 15, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
                                    ...
                                    <View style={{ alignItems: "center" }}>
                                        ...
                                        {/* <Text style={{ fontFamily: "lexendLight" }}>Upload NIN and document proof</Text> */}
                                    </View>
                                    <View />
                                </View>
                                ...
                                <View style={{ position: "absolute", bottom: 0, alignSelf: "center", marginBottom: 20 }}>
                                    <TouchableOpacity disabled={uploading} onPress={UploadNin} style={{ backgroundColor: AppColor.Blue, height: 50, justifyContent: "center", alignItems: "center", width: 300, borderRadius: 8 }}>
                                        {uploading ? (
                                            <ActivityIndicator color={'#fff'} size={'small'} />
                                        ) : (
                                            <Text style={{ color: "#fff", fontFamily: "lexendBold" }}>Verify</Text>
                                        )}
                                    </TouchableOpacity>
                                </View>
                            </View>
