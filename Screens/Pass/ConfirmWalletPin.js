...
export default function ConfirmWalletPin({ route }) {
	...
	async function Addpin() {
		if (otpCode !== Pin) {
			...
			fetch(`${BaseUrl}/user/wallet/pin/add`, {
				method: "POST",
				headers: {
				...
				<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
					<View style={styles.wrapper}>
						...
						<View style={{ margin: 15 }}>
							<Text style={{ fontFamily: "lexendBold", fontSize: 25, color: AppColor.Blue }}>Confirm Wallet PIN</Text>
							<Text style={{ fontFamily: "lexendLight", marginTop: 5 }}>To perform transactions on your PassCoder Account. Please confirm the 4 digit PIN.</Text>
						</View>
