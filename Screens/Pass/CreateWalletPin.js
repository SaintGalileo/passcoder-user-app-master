import { Image, KeyboardAvoidingView, Keyboard, Platform, StyleSheet, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View } from 'react-native'
...
export default function CreateWalletPin() {
	...
	const nextScreen = () => {
		if (otpCode.length < 4) {
			...
			nav.navigate('ConfirmWalletPin', { Pin: otpCode })
		}
	}
				...
				<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
					<View style={styles.wrapper}>
						...
						<View style={{ margin: 15 }}>
							<Text style={{ fontFamily: "lexendBold", fontSize: 25, color: AppColor.Blue }}>Create Your 4-Digit Wallet PIN</Text>
							<Text style={{ fontFamily: "lexendLight", marginTop: 5 }}>To perform transactions on your PassCoder Account. Please register a 4 digit PIN.</Text>
						</View>
