...
export default function Createpin() {
    ...
    const nextScreen = () => {
        if (otpCode.length < 4) {
            ...
            nav.navigate('Confirmpin',{Pin:otpCode})
        }
    }
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={styles.wrapper}>
                        ...
                        <View style={{ margin: 15 }}>
                            <Text style={{ fontFamily: "lexendBold", fontSize: 25, color: AppColor.Blue }}>Create Your 4-Digit PIN</Text>
                            <Text style={{ fontFamily: "lexendLight", marginTop: 5 }}>To protect the security of your PassCoder Account. Please register a 4 digit PIN.</Text>
                        </View>
