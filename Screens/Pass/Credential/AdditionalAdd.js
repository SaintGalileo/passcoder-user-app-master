import { ActivityIndicator, ScrollView, Image, Keyboard, StyleSheet, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View, Platform, Dimensions } from 'react-native';
...
export default function AdditionalAdd() {
    ...
    async function UploadAdditional() {
		...
		if (!name) {
			...
			fetch(`${BaseUrl}/proofs/credentials/additional/qualification`, {
				...
				fetch(`${BaseUrl}/user/additional/qualification/add`, {
					method: "POST",
					headers: {
						'passcoder-access-token': userToken,
						'Accept': 'application/json',
            ...
            <View style={styles.wrapper}>
                ...
                <View style={{ margin: 15, marginTop: 50, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <View>
                        ...
                        <Text style={{ textAlign: "center", fontFamily: "lexendLight" }}>Input details and upload proof</Text>
                    </View>
                    <View>
                ...
                <View style={{ position: "absolute", bottom: 0, alignSelf: "center", marginBottom: 20 }}>
                    <TouchableOpacity onPress={UploadAdditional} disabled={uploading} style={styles.uploadButton}>
                        {uploading ? (
