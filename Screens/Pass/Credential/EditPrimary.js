import { ActivityIndicator, Dimensions, Image, Keyboard, StyleSheet, Text, TextInput, TouchableOpacity, TouchableWithoutFeedback, View, ScrollView, Platform } from 'react-native';
...
export default function EditPrimary({ route }) {
	...
	async function UpdatePrimary() {
		...
		// } 
			...
			fetch(`${BaseUrl}/proofs/credentials/primary/school`, {
				...
				fetch(`${BaseUrl}/user/primary/school/edit/all`, {
					method: "PUT",
					headers: {
						'passcoder-access-token': userToken,
						'Accept': 'application/json',
			...
			<View style={styles.wrapper}>
				...
				<View style={{ margin: 15, marginTop: 50, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
					...
					<View>
						...
						<Text style={{ textAlign: "center", fontFamily: "lexendLight" }}>Update your first school leaving certificate</Text>
					</View>
					<View>
...

				{
					verified ?
						...
						<View style={{ position: "absolute", bottom: 0, alignSelf: "center", marginBottom: 20 }}>
							<TouchableOpacity onPress={UpdatePrimary} disabled={uploading} style={{ backgroundColor: AppColor.Blue, borderRadius: 8, height: 50, width: 300, justifyContent: "center", alignItems: "center" }}>
								{
									uploading ? (
