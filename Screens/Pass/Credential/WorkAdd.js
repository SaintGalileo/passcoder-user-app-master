    ...
    async function UploadWork() {
        ...
        if (!organisationName) {
            ...
            fetch(`${BaseUrl}/proofs/credentials/work/history`, {
                ...
                fetch(`${BaseUrl}/user/work/history/add`, {
                    method: "POST",
                    headers: {
                        'passcoder-access-token': userToken,
                        'Accept': 'application/json',
            ...
            <View style={styles.wrapper}>
                ...
                <View style={{ margin: 15, marginTop: 50, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <View>
                        ...
                        <Text style={{ textAlign: "center", fontFamily: "lexendLight" }}>Insert work history Details</Text>
                    </View>
                    <View>
                ...
                <View style={{ position: "absolute", bottom: 0, alignSelf: "center", marginBottom: 20 }}>
                    <TouchableOpacity onPress={UploadWork} disabled={uploading} style={styles.uploadButton}>
                        {uploading ? (
