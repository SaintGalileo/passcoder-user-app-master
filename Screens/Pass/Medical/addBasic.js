...
export default function AddBasic() {
	...
	const [geno, setGeno] = useState('AA')
	...
	async function AddData() {
		if (!height || height.length < 1) {
			...
			fetch(`${BaseUrl}/user/medical/details/add`, {
				method: "POST",
				headers: {
			...
			<View style={{ flex: 1, backgroundColor: "#fff" }}>
				...
				<View style={{ marginTop: 50, margin: 15, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
					...
					<View style={{ alignItems: "center" }}>
						...
						<Text style={{ fontFamily: "lexendLight" }}>Insert medical details</Text>
					</View>
					<View />
				</View>
				...
				<View style={{ margin: 15 }}>
					...
					<View style={{ marginBottom: 15 }}>
						<Text style={{ fontFamily: "lexendBold", marginBottom: 10 }}>Blood Group</Text>
					...
					<View style={{ marginBottom: 15 }}>
						<Text style={{ fontFamily: "lexendBold", marginBottom: 10 }}>Genotype</Text>
				...
				<View style={{ backgroundColor: "#FFFFFF", height: 90, bottom: 0, position: "absolute", width: Dimensions.get('screen').width }}>
					<View style={{width: 300, flex: 1, alignSelf: "center", top: 20 }}>
						<TouchableOpacity onPress={AddData} disabled={loading} style={{ backgroundColor: AppColor.Blue, borderRadius: 8, height: 50, width: 300, justifyContent: "center", alignItems: "center" }}>
							{loading ? (
