	...
	return (
		<View style={styles.wrapper}>
			...
			<Modal isVisible={showModal} onBackdropPress={() => setShowModal(false)}>
				<View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
					<View style={{ height: 400, width: 300, backgroundColor: "#fff", alignItems: "center", borderRadius: 8 }}>
						...
						/>
						<Text style={{ fontFamily: "lexendMedium", fontSize: 25 }}>Reset Pin</Text>
						<Text style={{ textAlign: "center", fontFamily: "lexendLight", margin: 10 }}>Are you sure you want to reset your pin?</Text>
			...
			<View style={{ margin: 15, marginTop: 50, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
				...
				<View>
					<Text style={{ fontFamily: "lexendBold", fontSize: 18, textAlign: "center" }}>Pin</Text>
					<Text style={{ textAlign: "center", fontFamily: "lexendLight" }}>Set up your account pin</Text>
				</View>
				<View>
				</View>
			</View>
							...
							
							{
								passUser?.pin ? 
									<>
										...
										<TouchableOpacity style={styles.optionStyle} onPress={() => nav.navigate('Updatepin')}>
									...
									<>
										<TouchableOpacity style={styles.optionStyle} onPress={() => nav.navigate('Createpin')}>
